# eddy_identification_winding — MATLAB

Eddy identification for HF radar data sets using the Winding Angle method using matlab
Modified and written by Douglas Cahl, PhD 
University of South Carolina 2023

Run from the repository root with <code>addpath('matlab')</code> so the
relative <code>data/</code> paths in the scripts resolve.
