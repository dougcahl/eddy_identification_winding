...
# for x in files:
    ...
    if avg_25hr == 1:
        ...
        uname = 'u_mean'
        vname = 'v_mean'
        if (region_num == 6) and (radar_km_resolution == 6):
            uname = 'u'
            vname = 'v'
    else:
        hr_name = 'hourly'
...
#    print(nc_time)
#    print(type(nc_time))
    timestamp_hour = np.array(nc_time/1.0)
#    timestamp_hour = nc_time
#    print(timestamp_hour)
#    print(type(timestamp_hour))
#    nc_time
#    timestamp_hour1 = 1;
    ...
    ncout.createDimension('Timestamp', 1)  

    # create variable array
    timestamp_hour_out = ncout.createVariable('timestamp_hour', np.dtype('double').char, ('Timestamp'))
    timestamp_hour_out.long_name = 'hours since offset'
    timestamp_hour_out.units = 'hours since offset'
    ...
    timestamp_hour_out[0]      = timestamp_hour
