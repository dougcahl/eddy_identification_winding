...
npz_out_name = dout_data + region + '_avg25hr_' + str(avg_25hr)  + '_eddy_tracks_' + str(radar_km_resolution) + 'km.npz'
mat_out_name = dout_data + region + '_avg25hr_' + str(avg_25hr)  + '_eddy_tracks_' + str(radar_km_resolution) + 'km.mat'
...
#    print(ncin_name)
    ...
    # get data
    timestamp_hour = np.array(ncin.variables['timestamp_hour'])
...
#    print(timestamp_hour)
    ttime.append(datetime.datetime(yyyy, mm, dd, hh, 0) + datetime.timedelta(hours = timestamp_hour))
#    print(ttime)
